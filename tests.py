...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_convertSalesforceToSFMR(self):
        ...
        self.assertEqual(sd.data,[['123456789', 'IDXR123467891376', '+fVQO/nZB7ZEySUzAK5eU8LT88HuJr1vINRQnufsEtM=', 'JOHN', 'STEINBECK', '5/10/12', '9:15 AM', '5/29/12', '1', '196', '1', '0', '0', '3', '0', '0', '1', '1']])
        remove(outputCSV)
